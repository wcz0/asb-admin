...
public class IndexService extends BaseService {
        ...
        public Result dashboard() {
                Map<Object, Object> page = AmisFactory.BasePage().css(this.css()).body(
                                new Object[] {
                                                ...
                                                AmisFactory.Grid().columns(new Object[] {
                                                                this.lineChart(),
                                                                AmisFactory.Flex().className("h-full")
                                                                                .items(new Object[] {
                                                                                                this.clock(),
                                                                                                this.hitokoto(),
        ...
        private Map<String, Object> css() {
                Map<String, Object> cssMap = new HashMap<>(5);

                Map<String, String> clearCardMb = new HashMap<>(5);
                clearCardMb.put("margin-bottom", "0 !important");
                cssMap.put(".clear-card-mb", clearCardMb);

                Map<String, String> cxdImage = new HashMap<>(5);
                cxdImage.put("border", "0");
                cssMap.put(".cxd-Image", cxdImage);

                Map<String, String> bgBlingbling = new HashMap<>(5);
                bgBlingbling.put("color", "#fff");
                bgBlingbling.put("background",
                                "linear-gradient(to bottom right, #2C3E50, #FD746C, #FF8235, #ffff1c, #92FE9D, #00C9FF, #a044ff, #e73827)");
                ...
                Map<String, String> bgBlingblingCardTitle = new HashMap<>(5);
        ...
        public Map<Object, Object> frameworkInfo() {
                return AmisFactory.Card().className("h-96").body(
                                AmisFactory.Wrapper().className("h-full").body(
                                                AmisFactory.Flex().className("h-full").direction("column")
                                                                .justify("center").alignItems("center").items(
                                                                                Arrays.asList(
                                                                                                AmisFactory.Image().src(
                                                                                                                url.get(logo))
                                                                                                                .render(),
                                                                                                AmisFactory.Wrapper()
                                                                                                                ...
                                                                                                                .items(
                                                                                                                                Arrays.asList(
                                                                                                                                                AmisFactory.Action()
                                                                                                                                                                ...
                                                                                                                                                                .actionType("url")
                                                                                                                                                                .blank(true)
                                                                                                                                                                .link("https://github.com/wcz0/asb-admin")
                                                                                                                                                                .render(),
                                                                                                                                                AmisFactory.Action()
                                                                                                                                                                .level("link")
                                                                                                                                                                .label("a-admin 地址")
                                                                                                                                                                .blank(true)
                                                                                                                                                                .actionType("url")
                                                                                                                                                                .link("http://github.com/wcz0/a-admin")
                                                                                                                                                                .render(),
                                                                                                                                                AmisFactory.Action()
                                                                                                                                                                .level("link")
                                                                                                                                                                .label("Amis 文档")
        ...
        public Map<Object, Object> lineChart() {
                ...
                String chartConfig = "{\n" +
                                ...
                                "  legend: { data: ['访问量','注册量'] },\n" +
                                "  series: [\n" +
                                "    { name: '访问量', data: [" + randomArr.toString()
                                + "], type: 'line', areaStyle: {}, smooth: true, symbol: 'none' },\n" +
                                "    { name:'注册量', data: [" + randomArr.toString()
                                + "], type: 'line', areaStyle: {}, smooth: true, symbol: 'none' }\n" +
                                "  ]\n" +
                                "}";
        ...
        public Map<Object, Object> cube() {
                ...
                return AmisFactory.Card().className("h-96 ml-4 w-8/12").body(
                                AmisFactory.Html().html(html).render()).render();
        ...
        public Map<Object, Object> pieChart() {
                ...
                return AmisFactory.Card().className("h-96").body(
                                AmisFactory.Chart().height(350).config(config).render()).render();
        }
