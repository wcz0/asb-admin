...
import com.wcz0.asb.tools.aims.Grid;
        ...
        return AmisFactory.Card().className("h-96").body(
                AmisFactory.Wrapper().className("h-full").body(
                        AmisFactory.Flex().className("h-full").direction("column").justify("center").alignItems("center").items(
                                Arrays.asList(
                                        AmisFactory.Image().src(url.get(logo)).render(),
                                        AmisFactory.Wrapper().className("text-3xl mt-9").body(appName).render(),
                                        AmisFactory.Flex().className("w-64 mt-5").justify("space-around").items(
                                                Arrays.asList(
                                                        AmisFactory.Action()
                                                                ...
                                                                .actionType("url")
                                                                .blank(true)
                                                                .link("https://github.com/wcz0/asb-admin").render(),
                                                        AmisFactory.Action()
                                                                .level("link")
                                                                .label("a-admin 地址")
                                                                .blank(true)
                                                                .actionType("url")
                                                                .link("http://github.com/wcz0/a-admin").render(),
                                                        AmisFactory.Action()
                                                                .level("link")
                                                                .label("Amis 文档")
                                                                .blank(true)
